...
import { XLookupWorker } from "./src/worker.js";

export { XLookupWorker } from "./src/worker.js";
export type { XLookupEnv } from "./src/worker.js";

/**
 * The stack's build program: registers the Effect-native Worker and resolves its
 * public URL. Tests execute this against Alchemy's in-memory state, so stack
 * validation remains credential-free.
 */
